...
<body>
<header>
    <div class="university" data-pl="Zachodniopomorski Uniwersytet Technologiczny w Szczecinie" data-en="West Pomeranian University of Technology in Szczecin">Zachodniopomorski Uniwersytet Technologiczny w Szczecinie</div>
</header>
<div class="sidebar">
...
<div class="content">
    ...
    <div class="bottom-buttons">
        <button data-pl="Dzień" data-en="Day">Dzień</button>
        <button data-pl="Tydzień" data-en="Week">Tydzień</button>
        <button data-pl="Miesiąc" data-en="Month">Miesiąc</button>
        <button data-pl="Semestr" data-en="Semester">Semestr</button>
