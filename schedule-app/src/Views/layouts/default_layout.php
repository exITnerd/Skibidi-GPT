...
<head>
    ...
    <link rel="stylesheet" href="styles/default_style.css"> <!-- CSS, it highlights the error, but it works - cause you run the server like this: php -S localhost:8000 -t public (in phpstorm project terminal) -->
</head>
<body>
<header>
    <div class="university">Zachodniopomorski Uniwersytet Technologiczny w Szczecinie</div>
</header>
<div class="sidebar">
    ...
    <div class="icon"><button><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-translate" viewBox="0 0 16 16">
...
<div class="content">
    <div class="buttons-container">
        <div class="logo">PLAN <span>ZUT</span></div>
        <input type="text" placeholder="Wykładowca">
        <input type="text" placeholder="Sala/Budynek">
    ...
    <div class="filters">
        ...
        <button>Audytorium</button> <br>
        <button>Wykład</button>
        <button>Lektorat</button>
    ...
    <div class="bottom-buttons">
        ...
        <button><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-short" viewBox="0 0 16 16">
        ...
        <button><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
                <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z"/>
            </svg></button>
    </div>
</div>
